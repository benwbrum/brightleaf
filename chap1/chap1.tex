...
%********** Chapter 1 **********
% TODO: Suppress the "Chapter 1" heading on page headers, the title, and the table of contents, if possible.
...
% TODO move figure and caption to previous page, so that it appears in/among
...
%TODO Figure out how to get the chart of children and the text about them 
% onto the same page, or at least without a huge blank chunk between them
...
%TODO Move picture near captions.  It's okay if picture and poem are on
% their own pages
...
%TODO Move picture and caption nearer "The Brumfield Place as it Used to Be"
...
%TODO: This sketch may appear anywhere near the yard description, including inline 
...
%TODO This needs to be at the top of the page beginning "The House Inside" 
% section
...
%TODO This diagram may appear anywhere within the descriptions of the ground 
% floor
...
% TODO Move this diagram into the kitchen section
...
%TODO This may need its own page, but the current location makes little sense
...
\begin{figure}[h]
\centering
\includegraphics[width=.9\textwidth]{shack_photo.jpg}
\label{}
\end{figure}
